    ...
    protected int goComposite(boolean simulate) throws DocumentException {
        ...
        while (true) {
            ...
            if (element.type() == Element.PARAGRAPH) {
                ...
                org.openpdf.text.List list = (org.openpdf.text.List) element;
                ...
                for (int k = 0; k <= items.size(); ++k) {
                    if (k == items.size()) {
                        if (!stack.isEmpty()) {
                            ...
                            list = (org.openpdf.text.List) objs[0];
                            items = list.getItems();
                            k = (Integer) objs[1];
                    ...
                    } else if (obj instanceof org.openpdf.text.List) {
                        stack.push(new Object[]{list, k, listIndentation});
                        list = (org.openpdf.text.List) obj;
                        items = list.getItems();
